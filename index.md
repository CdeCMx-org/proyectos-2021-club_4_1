...
:[](https://base.imgix.net/files/base/ebm/ecmweb/image/2019/04/ecmweb_10557_electrical_facts_2014_pr.png?auto=format&fit=crop&h=432&w=768)
...
Para esta investigación, se decidió tomar como base uno de los objetivos del club, el cual consistía en hacer una comparación entre las energías nuclear, renovable y combustible. Con el propósito de determinar la mejor opción energética.
A continuación, se explicarán conceptos básicos del funcionamiento de cada energía y sus aspectos negativos.

### Nuclear. 
La energía nuclear es la energía contenida en el núcleo de un átomo. Esta puede obtenerse a través de dos formas: fisión y fusión. 
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/CdeCMx-org/proyectos-2021-club_4_1/settings/pages). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
